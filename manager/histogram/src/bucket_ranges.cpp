...
void BucketRanges::InitializeLinearBuckets(int32_t minimum, int32_t maximum, size_t bucket_count)
{
    ...
    double bucket_width = static_cast<double>(maximum - minimum) / (bucket_count - MIN_LINEAR_BUCKET_COUNT);
